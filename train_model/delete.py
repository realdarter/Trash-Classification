...
if __name__ == '__main__':
    ...
    # Retrieve arguments from create_args function
    args = create_args(num_epochs=1, batch_size=32, learning_rate=1e-5)
    ...
    # Start training using the parameters from args
